...
import me.cmulugeta.airlinesbook.data.config.AppConstants.DELETE_CACHED_AIRPORT
import me.cmulugeta.airlinesbook.data.config.AppConstants.QUERY_GET_CACHED_AIRPORT
import me.cmulugeta.airlinesbook.data.config.AppConstants.QUERY_GET_CACHED_AIRPORTS
import me.cmulugeta.airlinesbook.data.config.AppConstants.QUERY_GET_CACHED_AIRPORTS_COUNT
import me.cmulugeta.airlinesbook.data.config.AppConstants.QUERY_GET_CACHED_AIRPORTS_DETAILS
import me.cmulugeta.airlinesbook.data.config.AppConstants.QUERY_GET_CACHED_AIRPORT_COUNT
