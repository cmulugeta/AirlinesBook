package me.cmulugeta.airlinesbook.data.store.local.db

import android.content.Context
import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import me.cmulugeta.airlinesbook.data.config.AppConstants.APP_DATABASE_NAME
import me.cmulugeta.airlinesbook.data.store.local.dao.CacheConfigDao
import me.cmulugeta.airlinesbook.data.store.local.dao.CachedAirportsDao
